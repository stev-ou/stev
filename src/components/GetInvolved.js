  ...
  <div className="container">
    <div className="dataview-container">
      ...
      <ul>
        ...
        <li><b>Source Code Contributions:</b> All source code is available online, hosted on <a href="https://github.com/stev-ou">GitHub</a>. We also use GitHub for bug tracking, issues, and suggested improvements as stated above. For those interested in contributing to software development, we encourage you to browse the *issues* in the <a href="https://github.com/stev-ou/stev">frontend repository</a> and find an issue you would like to address. Our current team is small and we graciously welcome source contributions! For more information, see "Pull Requests" below.</li>
      </ul>
      <h3 id="pull-requests">Pull Requests</h3>
      <p>Our source code is hosted on GitHub, in the organization <a href="https://github.com/stev-ou">stev-ou</a>. In order to make contributions, first fork and clone our repository to your local machine and build the site. The build instructions are included in the <a href="https://github.com/stev-ou/stev/blob/master/README.md">README</a> of each repository. Please consult the <a href="https://github.com/stev-ou/stev/blob/master/CONTRIBUTING.md">CONTRIBUTING.md</a> file for actionable details regarding contributing to our source. After creating a new branch and implementing your desired changes, open a pull request for review by our team. After passing the review and our continuous integration pipeline, your contributions will be included in our source! If you make many relevant contributions to the STEV source code, we would be happy to welcome you as a project maintainer or administrator.</p>
      <h3>Contact</h3>
